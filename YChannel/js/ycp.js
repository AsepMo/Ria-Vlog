...
$.fn.ycp = function(j) {
    ...
    $(this).each(function(i, a) {
        ...
        const title = ($(this).data('ycp_title') == undefined ? '../js/ycp.js' : $(this).data('ycp_title'));
    ...
    function ycp_list(h, f, g, k, l) {
        $.ajax({
            ...
            d += '<span class="tombol vid-next" title="Next videos">Next</span><span class="about" title="ycp.js"><center><div id="vid"></div></center></span></div><div class="handap">';
            ...
            if (c.prevPageToken == null || c.prevPageToken == undefined) {
                ...
                if (j.autoplay == false) {
					...
					$("#vid").html(`<a href="//www.yt-download.org/file/mp3/${e}?rel=${j.related ? 1 : 0}&amp">♥</a>`);
            ...
            $(`${l} .ycp div#ycp_youtube_channels${k} div.play`).each(function() {
                $(this).click(function() {
                    ...
                    if (j.autoplay == false) {
						...
						$("#vid").html(`<a href="//www.yt-download.org/file/mp3/${a}?rel=${j.related ? 1 : 0}&amp">♥</a>`);
